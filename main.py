...
st.markdown("Upload your resume and get a **summary, key skills score and improvement suggestion**")
        ...
        if st.button("Analyze Resume"):
            with st.spinner("Analyzing resume..."):
                ...
                4. A score out of 100 based on
                    ...
                    - Experience & acheivements (30 points)
                ...
                if len(parts)>1:
                    try:
                        ...
                        st.warning("Couldn't parse score JSON")